...
namespace Dibbs.Fhir.Liquid.Converter.Models
{
    public class PartialDateTime
    {
        public PartialDateTime(string input, DateTimeType type = DateTimeType.Fhir)
        {
            ...
            {
                DateTimeType.Ccda => PartialDateTimeRegexes.DateTimeRegex(),
                DateTimeType.Hl7v2 => PartialDateTimeRegexes.DateTimeRegex(),
                DateTimeType.Fhir => PartialDateTimeRegexes.FhirDateTimeRegex(),
